  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1a1c22]">
      ...
      >
        ...
        {success && (
          <div className="bg-[#1abc5b] text-white py-2 px-4 rounded mb-3 text-center text-base">
            {success}
          </div>
        )}
        <label className="text-[#bfc9da] text-base mb-1 mt-2">Name</label>
        <input
          name="name"
          value={form.name}
        ...
        />
        <label className="text-[#bfc9da] text-base mb-1 mt-2">User ID</label>
        <input
          name="user_id"
          value={form.user_id}
          onChange={handleChange}
